...
!window.angular.$$csp() && window.angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}</style>');;(function(angular) {
...
(function (angular) {
    angular.module("CandyInvoice")
        .controller('InvoicingController', ['$scope', '$http', '$rootScope', function ($scope, $http, $rootScope) {
            $scope.invoices = [];
            $scope.sortType = 'Date';
            ...
            $scope.showInvoice = function (invoiceId) {
                $rootScope.$broadcast('showInvoice', invoiceId);
            }
